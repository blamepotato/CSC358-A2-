...
class ComplexOSPFRouter(Topo):
    ...
    def __init__(self, **params):
        ...
        self.addLink(r3, r5, intfName1='r3-eth4', intftName2='r5-eth1',
                     params1={'ip': '10.113.0.1/24'},
                     params2={'ip': '10.113.0.2/24'})
        self.addLink(r3, r6, intfName1='r3-eth5', intftName2='r6-eth1',
                     params1={'ip': '10.114.0.1/24'},
                     params2={'ip': '10.114.0.2/24'})
        self.addLink(r4, r5, intfName1='r4-eth4', intftName2='r5-eth2',
                     params1={'ip': '10.115.0.1/24'},
                     params2={'ip': '10.115.0.2/24'})
        self.addLink(r5, r6, intfName1='r5-eth3', intftName2='r6-eth2',
...
topos = {'complextopology': (lambda: ComplexOSPFRouter())}
